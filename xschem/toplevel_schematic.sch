...
C {devices/lab_pin.sym} 390 230 0 1 {name=p11 sig_type=std_logic lab=scan_i
}
...
C {devices/lab_wire.sym} -880 400 0 1 {name=p40 sig_type=std_logic lab=vdrain2
...
C {devices/lab_wire.sym} -940 380 0 1 {name=p44 sig_type=std_logic lab=ib2

}
C {devices/lab_wire.sym} -1290 380 0 0 {name=p45 sig_type=std_logic lab=Vref1
}
...
C {devices/iopin.sym} -740 -130 0 0 {name=p64 lab=scan_en}
C {devices/lab_wire.sym} -80 410 0 1 {name=p6 sig_type=std_logic lab=en
}
C {window_comparator.sym} -1010 90 0 0 {name=x5}
C {devices/lab_pin.sym} -1220 30 2 1 {name=p37 sig_type=std_logic lab=clk
}
C {devices/lab_wire.sym} -560 290 1 1 {name=p52 sig_type=std_logic lab=a_gnd
}
C {devices/lab_wire.sym} -790 110 0 1 {name=p13 sig_type=std_logic lab=en
}
C {devices/lab_wire.sym} -840 130 0 1 {name=p38 sig_type=std_logic lab=shift
}
C {sky130_fd_sc_hd__inv_1.sym} -520 260 0 0 {name=x6
type=primitive
format="@name @@A @@VGND @@VNB @@VPB @@VPWR @@Y @symname"
template="name=x1"}
C {devices/lab_wire.sym} -530 290 1 1 {name=p53 sig_type=std_logic lab=a_gnd
}
C {devices/lab_wire.sym} -530 190 3 1 {name=p43 sig_type=std_logic lab=a_vdd
}
C {devices/lab_wire.sym} -500 190 3 1 {name=p58 sig_type=std_logic lab=a_vdd
}
C {devices/lab_pin.sym} -100 500 2 1 {name=p39 sig_type=std_logic lab=scan_i
}
C {devices/lab_pin.sym} 340 480 0 1 {name=p66 sig_type=std_logic lab=scan_out
}
C {devices/lab_wire.sym} -1270 50 0 0 {name=p68 sig_type=std_logic lab=vint+



}
C {devices/lab_wire.sym} -1280 70 0 0 {name=p69 sig_type=std_logic lab=vint-
