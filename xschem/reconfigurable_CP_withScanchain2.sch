...
type=primitive
format="@name @@clk @@data_out[2] @@data_out[5] @@data_out[7] @@enable @@reset @@scan_en @@scan_in @@scan_out @@shift @@data_out[4] @@data_out[1] @@data_out[6] @@data_out[3] @@VDD @@GND @@data_out[0] @symname"
template="name=x1"
